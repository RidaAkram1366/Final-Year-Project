              ...
              children: [
                CustomCard(
                  ...
                  child: Column(
                    ...
                    children: [
                      Image.asset('assets/images/3_das.jpeg',
              ...
              children: [
                CustomCard(
                  ...
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Image.asset('assets/images/4_das.png',
                          fit: BoxFit.fill, width: 120, height: 120),
                      const SizedBox(height: 8),
                    ],
                  ),
              ...
              children: [
                CustomCard(
                  ...
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Image.asset('assets/images/5_das.jpg',
                          fit: BoxFit.fill, width: 120, height: 120),
                      const SizedBox(height: 8),
                    ],
                  ),
              ...
              children: [
                CustomCard(
                  ...
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Image.asset('assets/images/6_das.jpg',
                          fit: BoxFit.fill, width: 120, height: 120),
                      const SizedBox(height: 8),
                    ],
                  ),
              ...
              children: [
                CustomCard(
                  ...
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Image.asset('assets/images/7_das.jpg',
                          fit: BoxFit.fill, width: 120, height: 120),
                      const SizedBox(height: 8),
                    ],
                  ),
              ...
              children: [
                CustomCard(
                  ...
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Image.asset('assets/images/8_das.jpg',
                          fit: BoxFit.fill, width: 120, height: 120),
                      const SizedBox(height: 8),
                    ],
                  ),
